...
<body>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">                            
                            <li><i class="fa fa-user"></i><a href="<?php echo base_url(); ?>allUsers">All User</a></li>
                            <li><i class="fa fa-clipboard"></i><a href="#">Users Report</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-plus"></i><a href="#">Add Category</a></li>
                            <li><i class="fa fa-table"></i><a href="#">Sub Category</a></li>
                            <li><i class="fa fa-bars"></i><a href="#">List Category</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-money"></i>Transaction</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-book"></i><a href="<?php echo base_url(); ?>bookings">Bookings</a></li>
                            <li><i class="fa fa-table"></i><a href="<?php echo base_url(); ?>project">Project</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="<?php echo base_url(); ?>newArtisan"> <i class="menu-icon fa fa-bell"></i>Notification </a>
                    </li>
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-archive"></i>Articles</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-table"></i><a href="<?php echo base_url(); ?>articles">All Articles</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-flag"></i>Abuses</a>
                        <ul class="sub-menu children dropdown-menu">
                    ...
                    <li>
                        <a href="<?php echo base_url(); ?>logout"> <i class="menu-icon fa fa-power-off"></i>Logout </a>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
        </nav>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <header id="header" class="header">
            <input type="hidden" value="<?php echo $this->session->userdata('token');?>" name="token" id="token" />
            <div class="top-left">
                ...
                <div class="header-menu">
                            ...
                            <div class="dropdown-menu" aria-labelledby="message">
                                ...
                                <a class="dropdown-item media" href="#">
                                    ...
                                    <div class="message media-body">
                                        <span class="name float-left">Test</span>
                    ...
                    <div class="user-area dropdown float-right">
                        ...
                        <div class="user-menu dropdown-menu">
                            <a class="nav-link" href="#"><i class="fa fa- user"></i><?php echo $this->session->userdata('userRole');?></a>
